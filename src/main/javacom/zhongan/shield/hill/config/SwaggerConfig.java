 ...
 * All right reserved. 
 */
package com.zhongan.shield.hill.config;
...
public class SwaggerConfig {
	...
	public static String CONTROLLER_URL="com.zhongan.shield.hill.controller";    //Swagger扫描的接口路径
	public static String SWAGGER_TITLE="API文档-za-wujian001"; 	    		//Swagger接口文档标题
